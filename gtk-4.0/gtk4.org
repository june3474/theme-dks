...
#+begin_src css
  ...
  /* image를 불러오는 것 관련해서,
     -gtk-icon-source는 gtk3 전용으로 gtk4에서는 폐기됨.
     대신 url(image-path)를 써서 특정 이미지를 불러 오든지, 아니면
     -gtk-icontheme("window-close")처럼 icon theme에서 불러올 수 있음.

     특히, icon theme에서 불러서 쓸 때는 아래 예처럼 symbolic icon을
     mask-image로 불러 쓰는 경우가 많음. 이 경우 svg의 opacity가 100%인 부분이
     background-color로 100% 색칠됨. foreground-color로 칠하려면 아래처럼
     background-color를 currentColor로 설정.
     
     [예시]
     button.close {
       -gtk-icon-shadow: none;
       mask-image: -gtk-icontheme("window-close-symbolic");
     ...
     추가로 HiDPI 대응용 꼼수 함수였던 -gtk-scaled()도 rendering 파이프라인이
     개선되면서 GTK4에서 제거됐음.
  ,*/
  headerbar button.titlebutton.close,
  .titlebar button.titlebutton.close,
  windowcontrols > button.close {
      background-image: url("objects/title-buttons/titlebutton-close.svg");
      background-color: transparent;
  }
  ...
  windowcontrols > button.close:backdrop {
      background-image: url("objects/title-buttons/titlebutton-close-backdrop.svg");
      background-color: transparent;      
  }
  ...
  windowcontrols button:backdrop:hover {
      background-image: url("objects/title-buttons/titlebutton-close-hover.svg");
      background-color: transparent;  /* button default override */
  }

  headerbar button.titlebutton.close:active,
  .titlebar button.titlebutton.close:active,
  windowcontrols button.titlebutton.close:active {
      background-image: url("objects/title-buttons/titlebutton-close-active.svg");
      background-color: transparent;
  }
  ...
  windowcontrols > button.maximize {
      background-image: url("objects/title-buttons/titlebutton-maximize.svg");
      background-color: transparent;    
  }
  ...
  windowcontrols > button.maximize:backdrop {
      background-image: url("objects/title-buttons/titlebutton-maximize-backdrop.svg");
      background-color: transparent;            
  }
  ...
  windowcontrols > button.maximize:backdrop:hover {      
      background-image: url("objects/title-buttons/titlebutton-maximize-hover.svg");
      background-color: transparent;      
  }
  ...
  windowcontrols button.titlebutton:active {
      background-image: url("objects/title-buttons/titlebutton-maximize-active.svg");
      background-color: transparent;
  }
  ...
  windowcontrols > button.minimize {
      background-image: url("objects/title-buttons/titlebutton-minimize.svg");
      background-color: transparent;          
  }
  ...
  windowcontrols > button.minimize:backdrop {
      background-image: url("objects/title-buttons/titlebutton-minimize-backdrop.svg");
      background-color: transparent;      
  }
  ...
  windowcontrols > button.minimize:backdrop:hover {
      background-image: url("objects/title-buttons/titlebutton-minimize-hover.svg");
      background-color: transparent;      
  }
  ...
  windowcontrols button.titlebutton.minimize:active {
      background-image: url("objects/title-buttons/titlebutton-minimize-active.svg");
      background-color: transparent;
  }
  ...
  windowcontrols > button.restore {
      background-image: url("objects/title-buttons/titlebutton-restore.svg");
      background-color: transparent;                
  }
  ...
  windowcontrols > button.titlebutton.restore:backdrop {
      background-image: url("objects/title-buttons/titlebutton-restore-backdrop.svg");
      background-color: transparent;      
  }
  ...
  windowcontrols button.titlebutton.restore:backdrop:hover {
      background-image: url("objects/title-buttons/titlebutton-restore-hover.svg");
      background-color: transparent;
  }
  ...
  /* useful only(?) for gtk4 file-roller */
  headerbar windowcontrols.start {
      margin-right: 5px;
  }
